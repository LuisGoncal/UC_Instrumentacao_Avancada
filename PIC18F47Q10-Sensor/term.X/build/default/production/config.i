...
# 1 "<built-in>" 1
# 1 "config.asm" 2
# 1 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\xc.inc" 1 3




# 1 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\pic18.inc" 1 3





# 1 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\pic18_chip_select.inc" 1 3
# 225 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\pic18_chip_select.inc" 3
# 1 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\proc\\pic18f47q10.inc" 1 3
# 47 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\proc\\pic18f47q10.inc" 3
CLCIN0PPS equ 0E1Fh
...
TOSU equ 0FFFh
# 26991 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\proc\\pic18f47q10.inc" 3
...
# 226 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\pic18_chip_select.inc" 2 3
# 7 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\pic18.inc" 2 3
...
auto_size SET 0
ENDM
# 6 "C:/Users/USER/.mchp_packs/Microchip/PIC18F-Q_DFP/1.17.379/xc8\\pic\\include\\xc.inc" 2 3
# 2 "config.asm" 2
...
_config:
    ...
    MOVWF ANSELA, 1 ; o pino ((PORTA) and 0FFh), 0, a é "1" -> analogico. Os restantes são zero.
    ...
    BSF TRISC,7 ;except ((PORTC) and 0FFh), 7, a, that will be used as RX - microchip specifies RX as input pin
                 ; ou seja ((PORTC) and 0FFh), 7, a vai ligar ao RX ou seja o bit 7 vai tomar valor 1, ((PORTC) and 0FFh), 7, a=1
    ...
    BANKSEL RC4PPS ; seleciona o registro RC4PPS
      ;((PORTC) and 0FFh), 4, a=pin 4 da porta C
      ; PPS = pin periferico . QUEREMOS LIGAR ((PORTC) and 0FFh), 4, a A UM periferico que vai ser EUSAT1 TX(TX=PINO DE TRANSMISSÃO)
    ...
    MOVLW 0x09 ; Q: WHAT VALUE MUST WE GIVE ((STATUS) and 0FFh), 6, a RC4PPS ((STATUS) and 0FFh), 6, a PUT THE EUSART1 TX ((CWG1CON1) and 0FFh), 5, b PIN ((PORTC) and 0FFh), 4, a? HINT: look in the 17.2 section of the datasheet, table 17.2
    MOVWF RC4PPS, 1 ;place the EUSART1 (TX/CK) in ((PORTC) and 0FFh), 4, a

    BANKSEL RX1PPS ;agr vamos ver onde está conectado o RX
     ; ((PORTC) and 0FFh), 7, a, BITS 4 e 3-- TEM QUE SER DA PORTA C--> 1 0 (respetivamente)
     ; 2,1,0 ---> pin 7 ent ta tudo a 1,--> 1 1 1
     ; os restantes sao neutro ent vao a 0
    MOVLW 0x17 ; ; Q: WHAT VALUE MUST WE GIVE ((STATUS) and 0FFh), 6, a RX1PPS ((STATUS) and 0FFh), 6, a PUT THE EUSART1 RX ((CWG1CON1) and 0FFh), 5, b PIN ((PORTC) and 0FFh), 7, a? HINT: look in the PPS chapter of the datasheet
    MOVWF RX1PPS, 1 ;place the EUSART1 (RX) in ((PORTC) and 0FFh), 7, a
    ...
    ; Q: WHAT VALUE SHOULD WE PUT ((CWG1CON1) and 0FFh), 5, b SP1BRGL AND SP1BRG1H ((STATUS) and 0FFh), 6, a GET A BAUD RATE OF 9600 BPS
...
; ;=============
; BANKSEL ADPCH
; MOVLW 0b00000000 ;set ((PORTA) and 0FFh), 0, a as ADC input
; MOVWF ADPCH, 1
;
; BANKSEL ADREF
...
;
; BANKSEL ADCON0
; MOVLW 0b10000000 ;Q: SET THE ADC ((STATUS) and 0FFh), 6, a: results left-justified, clock=Fosc/div, non-continuous operation
; MOVWF ADCON0, 1
;
;
;
