...
_config6:
    ...
    MOVLW 0b0001001 ; Q: WHAT VALUE MUST WE GIVE ((STATUS) and 0FFh), 6, a RC4PPS ((STATUS) and 0FFh), 6, a PUT THE EUSART1 TX ((CWG1CON1) and 0FFh), 5, b PIN ((PORTC) and 0FFh), 4, a? HINT: look in the 17.2 section of the datasheet, table 17.2
    ...
    BANKSEL ADPCH ;set ((PORTA) and 0FFh), 0, a as ADC input ; na tabela da pag 585 vemos que
