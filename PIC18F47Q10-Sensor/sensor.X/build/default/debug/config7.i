...
_config7:
    ...
    BANKSEL RC4PPS ;TX ((PORTC) and 0FFh), 4, a ; MICRO - PC
    ...
    ; VER FREQUENCIA EM QUE O MICRO TRABALHA

    ; PERGUNTAR AO PROFESSOR :) <3


    BANKSEL SP1BRGL

    MOVLW 51 ; 9600 baud rate
    ...
    BANKSEL ADPCH
    MOVLW 0b00001000 ;((PORTB) and 0FFh), 0, a Hardware para o micro
